...
function Index() {
  return <main className="barber-site">
    ...
    <section className="booking"><p className="eyebrow">RENDEZ-VOUS</p><h2>Prêt pour votre<br/><i>prochain look ?</i></h2><a className="primary big" href="/reservation">Prendre rendez-vous →</a></section>
